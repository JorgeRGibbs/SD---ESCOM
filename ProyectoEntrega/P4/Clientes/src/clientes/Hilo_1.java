...
public class Hilo_1 extends UnicastRemoteObject implements Runnable, Serializable {
    ...
    public Hilo_1(int hora, int minuto, int segundo, JTextField Texto) throws RemoteException {
        this.hora = hora;
        this.minuto = minuto;
