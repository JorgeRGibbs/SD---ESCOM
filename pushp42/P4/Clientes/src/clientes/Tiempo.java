...
import static clientes.Tiempo.uno;
...
public class Tiempo extends javax.swing.JFrame {
    ...
    static Hilo tres;
    static Hilo cuatro;
    static TiempoServer listen;
    int port;
    String nombre;
    final JFileChooser fileChooser = new JFileChooser();
    String fileName;
    //TiempoServer.setPort(8888);
   
    
     
    public Tiempo() throws RemoteException, IOException {
        initComponents();
        ...
        listen = new TiempoServer();
        TiempoServer.setPort(5082);
