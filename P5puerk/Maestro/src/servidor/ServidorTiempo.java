...
//import hilo.Hilito;
import static servidor.ServidorTiempo.cuatro;
...
public class ServidorTiempo extends javax.swing.JFrame {
    ...
    public ServidorTiempo() throws RemoteException {
        initComponents();
        this.setTitle("Reloj");
...
//        cuatro = new Hilo((int) (Math.random() * 24), (int) (Math.random() * 60), (int) (Math.random() * 60), hora4);
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Servidor 1");
        ...
        jRadioButton2.setText("Servidor 2");
        ...
        jRadioButton3.setText("Hora local");
...
//        cuatro.valor = true;
    ...
    private void EnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnviarActionPerformed
        try {
            ...
            switch (selectedOption) {
                case "2":
                    enviar(dos, hora2,puerto);
                    break;
                case "1":
                    //enviar(dos, hora2,puerto+1);
                    break;
                case "3":
                    enviar(tres, hora3,puerto+1);
                    break;
                case "4":
    ...
    public static void main(String args[]) throws RemoteException, MalformedURLException, InterruptedException, AlreadyBoundException {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ServidorTiempo().setVisible(true);
